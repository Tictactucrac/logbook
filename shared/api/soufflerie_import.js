// /api/soufflerie_import.js
// Reçoit une liste de sessions déjà filtrées (nouvelles uniquement, session_index déjà
// calculé côté frontend) et les insère en une seule requête groupée dans Supabase.
...
module.exports = async function handler(req, res) {
  ...
  const payload = rows.map(r => ({ ...r, source: 'import' }));
